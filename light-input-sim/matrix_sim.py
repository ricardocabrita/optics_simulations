...
if __name__ == "__main__":
    ...
    led405nm_theta = 15
    led405nm = ledObject(sample_size, z_pos=0, x_pos=0.7, distribution='bull', dist_to_diff=7)
    ...
    fig2 = plt.figure(2)
    #plt.hist(led405nm.cut_dif_angle, nbins, density=True, color='r',histtype='step',label="dif polar angle, smd UVLED")
