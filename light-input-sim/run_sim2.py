...
if __name__ == "__main__":
    ...
    fig2 = plt.figure(2)
    plt.scatter(capx1, capz1, label='2in LED-diffuser, 1in diffuser-pinhole')
    plt.scatter(capx2, capz2, label='2in LED-diffuser, 1.5in diffuser-pinhole')
    plt.scatter(capx3, capz3, label='2in LED-diffuser, 2in diffuser-pinhole')
    plt.legend()
    plt.xlabel("x (cm)")
    plt.xlabel("z (cm)")
    plt.show()
