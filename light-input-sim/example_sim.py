...
ax.quiver(zeropos[:,0], zeropos[:,1], transpos[:,2], rri[:, 0]*5.08, rri[:,1]*5.08, rri[:, 2]*5.08, length=0.6, colors=[(0.5,0,0.5)])
ax.quiver(zeropos[:,0], zeropos[:,1], transpos[:,2], rri[:, 0], rri[:,1], rri[:, 2], length=0.6, colors=[(1,0,0)])
ax.set_zlim3d(-1, 1.5)
ax.set_ylim3d(-0.4, 6)
ax.set_xlim3d(-0.4, 4)
plt.show()
